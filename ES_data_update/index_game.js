...
async function index_game() {
  ...
  let jobSize = 10;
  let myWorker1, myWorker2, myWorker3, myWorker4, myWorker5, myWorker6, myWorker7, myWorker8;
  ...
  myWorker7 = new Worker(__dirname + "/game.js"); // 스레드를 생성해 파일 절대경로를 통해 가리킨 js파일을 작업
